...
3.EduRoute-
A React app demonstrating **client-side routing** using **react-router-dom** to create multiple pages without page reloads.A routing-first e-learning platform built with React, Node.js, Express, and MySQL.
Features advanced UI/UX with glassmorphism, animations, and comprehensive routing architecture.
